...
// 3 × 1000 ms = 3 s of silence before error is flagged.
...
//   a) as the watchdog timeout multiplier (SHELLY_ERROR_THRESHOLD × this)
...
// (apower / (V × I)), not a direct hardware measurement.  See Req 5 / Req 7c.
#define LOG_FILE_HEADER  "time_ms,voltage_V,power_W,pf_apparent"

// ===== RAM-Puffer =====
// 64 × 16 Byte = 1024 Byte.
